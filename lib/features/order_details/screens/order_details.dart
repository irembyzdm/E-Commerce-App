import 'package:alisveris_app/common/widgets/custom_button.dart';
import 'package:alisveris_app/constants/global_variables.dart';
//import 'package:alisveris_app/features/admin/screens/admin_screen.dart';
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Sipariş Tarihi:            ${DateFormat().format(
                      DateTime.fromMillisecondsSinceEpoch(
                          widget.order.orderedAt),
                    )}'),
                    Text('Sipariş Numarası:      ${widget.order.id}'),
                    Text(
                        'Sipariş Tutarı:            ${widget.order.totalPrice}\₺'),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Stepper(
                  ...
                  steps: [
                    ...
                    Step(
                      title: const Text('Yola Çıktı'),
                      content: const Text(
                        'Siparişiniz size teslim edilmek üzere yola çıktı.',
                      ),
                    ...
                    Step(
                      ...
                      content: const Text(
                        'Siparişiniz size teslim edildi.',
                      ),
